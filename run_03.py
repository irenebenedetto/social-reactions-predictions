...
if __name__ == "__main__":
    ...
    X_train = pd.read_csv(f'{input_folder}/dataset/X_train.csv', index_col='id')[features]
    X_test = pd.read_csv(f'{input_folder}/dataset/X_test.csv', index_col='id')[features]
    X_val = pd.read_csv(f'{input_folder}/dataset/X_val.csv', index_col='id')[features]
